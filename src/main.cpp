...
#include <vector>
#include <memory>
#include "GLViewAyshahFinal.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewAyshahFinal > glView( Aftr::GLViewAyshahFinal::New( args ) );
